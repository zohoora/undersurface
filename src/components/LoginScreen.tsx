...
function getSubmitLabel(isSigningIn: boolean, isSignUp: boolean): string {
...
export function LoginScreen() {
  ...
  return (
    <div style={{
      ...
      <form onSubmit={handleEmailSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 10, marginTop: 8 }}>
        <input
          type="email"
          placeholder="Email"
          value={email}
        ...
        >
          {getSubmitLabel(isSigningIn, isSignUp)}
        </button>
        <button
          type="button"
